...
void Norwidget::on_norbackbon_clicked()
{
    ...
    ui->scolabel->move(400,400);
    ui->stackedWidget->setCurrentIndex(1);
    /*connect(scotimer,&QTimer::timeout,
            [=]()
            {
        QPropertyAnimation* animation61 = new QPropertyAnimation(ui->scolabel, "geometry");
              animation61->setDuration(200);
              animation61->setStartValue(QRect(400, 400, 200, 200));
              animation61->setEndValue(QRect(375,430,230,170));
              animation61->setEasingCurve(QEasingCurve::OutQuart);
        QPropertyAnimation* animation62 = new QPropertyAnimation(ui->scolabel, "geometry");
              animation62->setDuration(200);
              animation62->setStartValue(QRect(375,430,230,170));
              animation62->setEndValue(QRect(400,250,200,200));
              animation62->setEasingCurve(QEasingCurve::OutQuart);
        QPropertyAnimation* animation63 = new QPropertyAnimation(ui->scolabel, "geometry");
              animation63->setDuration(200);
              animation63->setStartValue(QRect(400,250,200,200));
              animation63->setEndValue(QRect(400,400,200,200));
              animation63->setEasingCurve(QEasingCurve::OutQuart);
        QSequentialAnimationGroup*scodynamic=new QSequentialAnimationGroup(this);
