...
void Widget::on_startbon_pressed()
{
  ...
  //压缩动画
   QPropertyAnimation*animation11 = new QPropertyAnimation(ui->label, "geometry");
        ...
        animation11->setEndValue(QRect(75, 230, si/2+50, si-50));
...
void Widget::on_startbon_released()
{
    ...
    ui->label->show();
          ...
          animation1->setStartValue(QRect(75,230, si/2+50, si-50));
    ...
    //失败
        ...
        if(i>num+60)animation2->setEndValue(QRect(2000,500,si/2,si));
        if(i<num)animation2->setEndValue(QRect(num,500,si/2,si));
