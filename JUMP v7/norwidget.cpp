    ...
    ui(new Ui::Norwidget)
{
    ...
    animation40 = new QPropertyAnimation(ui->norlabel, "geometry");
          ...
          animation40->setEndValue(QRect(100,110, si/2,si));
...
void Norwidget::on_NORBON_pressed()
{
    ...
    //压缩动画
     QPropertyAnimation*animation11 = new QPropertyAnimation(ui->norlabel, "geometry");
          ...
          animation11->setStartValue(QRect(100,110, si/2, si));
          animation11->setEndValue(QRect(75, 190, si/2+50, si-50));
...
void Norwidget::on_NORBON_released()
{
    ...
    ditimer->stop();
          ...
          animation1->setStartValue(QRect(75,190, si/2+50, si-50));
          animation1->setEndValue(QRect(100+i1/2, 30, si/2, si));
          animation1->setEasingCurve(QEasingCurve::OutQuart);
          animation2 = new QPropertyAnimation(ui->norlabel, "geometry");
          animation2->setDuration(200);
          animation2->setStartValue(QRect(100+i1/2, 30, si/2, si));
          animation2->setEasingCurve(QEasingCurve::OutQuart);

          animation3 = new QPropertyAnimation(ui->norlabel, "geometry");
                animation3->setDuration(500);
                animation3->setStartValue(QRect(100+i1, 110, si/2, si));
                animation3->setEndValue(QRect(100,110,si/2,si));
    ...
    {
        animation2->setEndValue(QRect(100+i1,110,si/2,si));
